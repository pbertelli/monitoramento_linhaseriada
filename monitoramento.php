<html>
 ...
 <body>
 	<div class="title" align="center">
		...
		if(isset($_POST["na"])){
		    $up = mysqli_query($con,"UPDATE flag SET flag = '1'");
		}
		...
		<?php
			if($row1['flag'] == 2){
				header('Location: monitoramento_parado.php');
				echo "SISTEMA <font size: 60 color='#FFFF00'>PARADO</font>";
			} else if ($row1['flag'] == 1) {
				echo "SISTEMA <font size: 60 color='#00FF00'>OPERANDO</font>";
			} else if ($row1['flag'] == 0) {
				echo "SISTEMA <font size: 60 color='#FF0000'>DESLIGADO</font>";
			}

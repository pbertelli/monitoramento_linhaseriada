 ...
 <body>
 	<div class="title" align="center">
		...
		<?php
			...
			echo "RELATORIO DO DIA  <font color='#ff0000'>" . $corrigido."</font>";
	...
	<?php
		...
		$table .= '<tr>';
		$table .= '<td>ID</td>';
		$table .= '<td>Conforme</td>';
		$table .= '<td>Inconforme</td>';
		$table .= '<td>Data</td>';
		$table .= '<td>Horario</td>';
		$table .= '</tr>';
		$table .= '</thead>';
		...
		for($i=0; $i<$linhas; $i++)
		{
				...
				if($table_data == $data)
				{
					$table_data = new DateTime($table_data);
					$formato = $date->format('d/m/Y');

			        $table .= '<tr>';
			        $table .= '<td>'.$row['ID'].'</td>';
			        $table .= '<td>'.$row['qtd_ok'].'</td>';
			        $table .= '<td>'.$row['qtd_erro'].'</td>';
			        $table .= '<td>'.$formato.'</td>';
			        $table .= '<td>'.$row['horario'].'</td>';
			        $table .= '</tr>';
				}
